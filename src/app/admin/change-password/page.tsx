  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md items-center px-4 py-10">
      <section className="card w-full">
        <h1 className="text-3xl font-black">비밀번호 변경</h1>
        <p className="mt-2 text-sm text-gray-600">최초 로그인 비밀번호를 새 비밀번호로 변경해야 합니다.</p>
        <form onSubmit={submit} className="mt-6 grid gap-4">
          ...
          <button className="btn" disabled={loading}>{loading ? '변경 중...' : '비밀번호 변경'}</button>
        </form>
